...
useEffect(() => {
  ...
  return (
   <div>
      <Header/>
       <div className="flex justify-around  p-20 m-10 border-0 shadow-2xl rounded-2xl bg-amber-10">
        <div className="w-2/5 ..."> <img src={bookdata?.imageUrl} width={'300px'} height={'200px'} alt="" />
        </div>
        
        <div className="w-3/5 text-center">
              <div className='flex justify-end'>
                <h3 className='text-3xl my-5'  >  <IoIosImages onClick={() => setOpenModal(true)}/></h3>
                <Modal show={openModal} onClose={() => setOpenModal(false)}>
                       ...
                       <div className='flex text-blue-500 items-center my-5'>
                         <HiCamera/> 
                         <p>Camera click of the book in the han of seller</p>
                       </div>
<div className=" !bg-amber-50 space-y-6 flex gap-10">
                       { UploadedImages? UploadedImages?.map((item)=>(
                          <img width={'200px'} src={`${serverURL}/upload/${item}`} alt="" />
                         ) ) :"no"   }
        ...
        <p>Publisher : {bookdata?.publisher}
          </p>

          <p>Language : {bookdata?.language}
          </p>

          <p>No. of pages : {bookdata?.noofpages}
          </p>

          <p>Seller Mail : {bookdata?.userMail}
          </p>

          <p>Real Price : $ {bookdata?.dprice}
          </p>
